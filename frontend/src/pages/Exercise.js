import { Container, Grid, Box, Paper, Button, Typography, Divider, TextField, useScrollTrigger } from "@mui/material"
                        ...
                        <Container>
                            ...
                            <Grid container>
                                ...
                                <Grid item xs={12}>
                                    ...
                                    {
                                        dataArray.map((data, key) => <ControlledAccordion key={key} title={data.date}/>)
                                    }
